...
/**
 * Abstract class decorating the actual instance of the SUreFirePlugin. Almost
 * all you'll find here is Maven annotation and setters/getters for Surefire to
 * receive all required parameters. You'll notice all these setters do is pass
 * the parameters along to the encapsulated instance.
 */
public abstract class DecoratorTestPlugin extends AbstractMojo implements
    ...
    protected SurefirePlugin getPlugin() {
